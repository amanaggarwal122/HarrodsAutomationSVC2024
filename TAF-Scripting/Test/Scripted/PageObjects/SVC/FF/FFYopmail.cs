...
namespace TAF_Scripting.Test.Scripted.PageObjects.SVC.FF
{
    class FFYopmail
    {
        ...
        #region  Constructor
        public FFYopmail(IWebDriver driver, Configuration configuration)
        {
            this.driver = driver;
        ...
        [FindsBy(How = How.XPath, Using = "//input[@name='emailCode_0']")]
        private IWebElement BBEnterEmailOTPInput;

        [FindsBy(How = How.XPath, Using = "//input[@value='Continue'][1]")]
        private IWebElement BBEnterEmailOTPContinues;
        ...
        public void PerformEmailValidationFromYopmail(string Email)
        {
            ...
            //driver.Navigate().GoToUrl(CommonFunctions.RewriteFarfetchUrl(config.BBBookingUrl, config));
            BrowserDriver.Sleep(2000);
            BrowserDriver.Sleep(2000);
            driver.Close();
