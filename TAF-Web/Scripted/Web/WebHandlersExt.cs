...
namespace TAF_Web.Scripted.Web
{
    ...
    {
        public void Clic5(IWebElement locator, string logMsg="")
        {
            try
            {
        ...
        public void Click(IWebElement locator, string logMsg = "")
        {
            //Console.WriteLine(e.Message);
            try
            {
        ...
        public bool WebElementExists(IWebElement locator, string logMsg="")
        {
            try
            {
        ...
        public void ClickByJsExecutor(IWebElement element, string logMsg = "")
        {
            try
            {
                if (element.Enabled && element.Displayed)
                {
                   ...
                   // log.Info("Click action completed successfully for the locator");
                    log.Info(logMsg != "" ? string.Concat("Click action completed successfully for the ", logMsg) : "Click action completed successfully for the locator");
                }
                else
                {
                    //log.Info("Unable to click on element");
                    log.Info(logMsg != "" ? string.Concat("Unable to click on ", logMsg) : "Unable to click on element");
                }
            }
            catch (Exception ex)
            {
        ...
        public bool CompareText(String strActualText, String strCompText)
        {
            ...
            try
            {
                ...
                if (strActualText.ToLower().Trim().Equals(strCompText.ToLower().Trim()))
                {
                    compFlag = true;
                }
                else
        ...
        public void RemoveItemsFromCart(IWebElement parentElement, IWebElement remove, IWebElement confirmRemove=null)
        {
