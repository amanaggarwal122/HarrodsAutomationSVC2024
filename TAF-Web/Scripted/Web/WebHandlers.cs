...
namespace TAF_Web.Scripted.Web
{
    public partial class WebHandlers
    {
        ...
        public bool isElementPresent(By locatorKey)
        {
            try
            {
                BrowserDriver.GetDriver().FindElement(locatorKey);
                return true;
            }
        ...
        public void EnterText(IWebElement locator, String value , string logMsg = "")
        {
            try
            {
              //WebWaitHelper.Instance.WaitForClear(locator);
                locator.Clear();
                //locator.SendKeys(Keys.Control + "a" + Keys.Delete);
                locator.SendKeys(value);
               
                log.Info(logMsg != "" ? logMsg : "Text entered successfully");
            }
            catch (Exception e)
            {
        ...
        public void EnterTextInModalPopup(IWebElement locator, String value, string logMsg = "")
        {
            try
            {
                WebWaitHelper.Instance.WaitForClearModalPopup(locator);
                locator.Clear();
                locator.SendKeys(value);
                log.Info(logMsg != "" ? logMsg : "Text entered successfully");
            }
        ...
        public void ClickByJsExecutor(By locator, string logMsg = "")
        {
            ...
            try
            {
                ...
                if (element.Enabled && element.Displayed)
                {
                    ...
                    log.Info(logMsg != "" ? logMsg : "Click action completed successfully for the locator");
                }
                else
                {
                    //1og.Info("Unable to click on element");
        ...
        public bool ExistText(IWebElement locator, string logMsg ="")
        {
            try
            {
                ...
                else
                {
                    bExistText = true;
                    //log.Info("Text exits ");
                    log.Info(logMsg != "" ? logMsg : "Text exits ");
                }
            }
            catch (Exception e)
            {
        ...
        public void ClearText(IWebElement locator, string logMsg="")
        {
            try
            {
                WebWaitHelper.Instance.WaitForElement(locator);
                ...
                log.Info(logMsg != "" ? logMsg : "Text cleared successfully ");
        ...
        public bool ObjDisabled(IWebElement locator, string logMsg="")
        {
            bool eFlag = false;
            try
            {
                ...
                {
                    eFlag = true;
                    log.Info(logMsg != "" ? string.Concat(logMsg ," is disabled") : "Object is disabled");
                }
                else
                {
                    eFlag = false;
                    //log.Info("Object is enabled");
                    log.Info(logMsg != "" ? string.Concat(logMsg, " is enabled") : "Object is enabled");
                }             
            }
            catch (Exception e)
            {
        ...
        public void VerifyProperty(IWebElement locator, String property, String expected, string logMsg="")
        {
            String actual = "";
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "Property value fetched successfully for the locator");
            }
            catch (Exception e)
            {
        ...
        public void DoubleClick(IWebElement locator, string logMsg="")
        {
            try
            {
                WebWaitHelper.Instance.WaitForElement(locator);
                ...
                log.Info(logMsg != "" ? logMsg : "Double click performed successfully");
            }
            catch (Exception e)
            {
        ...
        public void RightClick(IWebElement locator, string logMsg="")
        {
            try
            {
                WebWaitHelper.Instance.WaitForElement(locator);
                ...
                log.Info(logMsg != "" ? logMsg : "Right click performed successfully");
            }
            catch (Exception e)
            {
        ...
        public void ObjExists(IWebElement locator, string logMsg = "")
        {
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "objExists check completed successfully, Object exists ");
            }
            catch (Exception e)
            {
        ...
        public bool Elementnotpresent(IWebElement locator, string logMsg = "", string Time = "0" )
        {
            try
            {
                By byEle = WebHandlers.Instance.WebElementToBy(locator);
                if (Time.Equals("0"))
                    WebWaitHelper.Instance.Waituntilelementnotpresent(byEle, WebWaitHelper.Instance.GetElementTimeout());
                else
                    WebWaitHelper.Instance.Waituntilelementnotpresent(byEle, TimeSpan.FromSeconds(Double.Parse(Time)));
                                    // log.Info("objExists check completed successfully, Object exists ");
                                    log.Info(logMsg != "" ? logMsg : "objExists check completed successfully, Object exists ");
            }
            catch (Exception e)
            {
                string msg = ("Error occurred while checking whether the object not exists " + "Exception :" + e);
                LogMessage(msg, true, true, false, true, e);
                return false;
            }
        ...
        public bool ChkboxIsChecked(IWebElement locator, string logMsg = "")
        {
            WebWaitHelper.Instance.WaitForElement(locator);
            bool eFlag = false;
            try
        ...
        public bool DropDownSetByVal(IWebElement locator, String value, string logMsg = "")
        {
            bool flag = false;
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : " The action dropDownSetByVal completed successfully ");
                return flag;
            }
            catch (Exception e)
            {
        ...
        public bool DropDownSetByIndex(IWebElement locator, int index, string logMsg="")
        {
            bool flag = false;
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "The action dropDownSetByIndex completed successfully");
                return flag;
            }
            catch (Exception e)
            {
        ...
        public void SSCCustomDropDownSetByVal(By Object, string Value)
        {
            BrowserDriver.GetDriver().FindElement(Object).Click();
            BrowserDriver.Sleep(2000);
            if (Value == "Green 1")
                BrowserDriver.GetDriver().FindElement(By.XPath("//li[contains(text(),'Green')][2]")).Click();
            else if (Value == "Green 2")
                BrowserDriver.GetDriver().FindElement(By.XPath("//li[contains(text(),'Green')][3]")).Click();
            else if (Value == "£15-Hot Beverage")
                {BrowserDriver.GetDriver().FindElement(Object).SendKeys(Keys.ArrowDown);
                 BrowserDriver.Sleep(1000); BrowserDriver.GetDriver().FindElement(Object).SendKeys(Keys.Enter); }
            else
                BrowserDriver.GetDriver().FindElement(By.XPath("//li[contains(text(),'" + Value + "')][1]")).Click();
            BrowserDriver.Sleep(1000);
        }

        public void SSCCustomDropDownSelectValue(By Object, string Value)
        {
            BrowserDriver.GetDriver().FindElement(Object).Click();
            BrowserDriver.Sleep(1000);
            BrowserDriver.GetDriver().FindElement(Object).Clear();            
            BrowserDriver.GetDriver().FindElement(Object).SendKeys(Value);
            BrowserDriver.Sleep(1000);
        }
        ...
        public bool MultiSelectByText(IWebElement locator, String options,string logMsg="")
        {
            ...
            try
            {
                ...
                for (int i = 0; i < optionList.Count; i++)
                {
                    ...
                    ///*
                    log.Info($"Selected {optionList[i].ToString()}");
                }
                flag = true;
                return flag;
            }
        ...
        public Dictionary<String, int> GetTblHeaderVal(IWebElement locator, string logMsg="")
        {
            ...
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "getTblHeaderVal action completed successfully");
            }
            catch (Exception e)
            {
        ...
        public Dictionary<String, int> GetTblBodyVal(IWebElement locator, string logMsg="")
        {
            ...
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "getTblBodyVal action completed successfully");
            }
            catch (Exception e)
            {
        ...
        public String GetTblTdVal(IWebElement locator, int rowIndex, int colIndex, string logMsg="")
        {
            ...
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "The getTblTdVal action completed successfully");
            }
            catch (Exception e)
            {
        ...
        public String GetTblThVal(IWebElement locator, int rowIndex, int colIndex, string logMsg="")
        {
            IWebElement ele = null;
            ...
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "getTblThVal action completed successfully");
            }
            catch (Exception e)
            {
        ...
        public String GetIndexofVal(IWebElement locator, String value, string logMsg="")
        {
            ...
            try
            {
                ...
                log.Info(logMsg != "" ? logMsg : "getIndexofVal action completed successfully");
            }
            catch (Exception e)
            {
        ...
        private Dictionary<string, string> GetLocatorAndUsing(IWebElement webElement)
        {
            ...
            Type[] exceptionTypesToIgnore = new Type[] { typeof(System.NullReferenceException) };
